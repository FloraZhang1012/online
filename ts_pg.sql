-- SQLINES DEMO ***  Distrib 8.4.5, for macos13.7 (arm64)
--
-- SQLINES DEMO ***   Database: ts
-- SQLINES DEMO *** -------------------------------------
-- SQLINES DEMO *** 0.28
...
/* SQLINES DEMO *** LE `auth_group` DISABLE KEYS */;
/* SQLINES DEMO *** LE `auth_group` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE INDEX auth_group_permissions_permission_id_fk ON auth_group_permissions (permission_id);
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
/* SQLINES DEMO *** LE `auth_group_permissions` DISABLE KEYS */;
/* SQLINES DEMO *** LE `auth_group_permissions` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE auth_permission (
  ...
  PRIMARY KEY (id),
  CONSTRAINT auth_permission_codename_content_type_id_uniq UNIQUE  (codename,content_type_id)
)  ;

ALTER SEQUENCE auth_permission_seq RESTART WITH 137;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
/* SQLINES DEMO *** LE `auth_permission` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `auth_permission` ENABLE KEYS */;
UNLOCK TABLES;
...
ALTER SEQUENCE auth_user_seq RESTART WITH 3;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
/* SQLINES DEMO *** LE `auth_user` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `auth_user` ENABLE KEYS */;
UNLOCK TABLES;
...
/* SQLINES DEMO *** LE `auth_user_groups` DISABLE KEYS */;
/* SQLINES DEMO *** LE `auth_user_groups` ENABLE KEYS */;
UNLOCK TABLES;
...
/* SQLINES DEMO *** LE `auth_user_user_permissions` DISABLE KEYS */;
/* SQLINES DEMO *** LE `auth_user_user_permissions` ENABLE KEYS */;
UNLOCK TABLES;
...
ALTER SEQUENCE django_admin_log_seq RESTART WITH 2;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
ALTER SEQUENCE django_content_type_seq RESTART WITH 32;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
/* SQLINES DEMO *** LE `django_content_type` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `django_content_type` ENABLE KEYS */;
UNLOCK TABLES;
...
ALTER SEQUENCE django_migrations_seq RESTART WITH 44;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;
...
/* SQLINES DEMO *** LE `django_migrations` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `django_migrations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE django_session (
  ...
  session_data text CHARACTER SET utf8mb4 NOT NULL,
...
/* SQLINES DEMO *** LE `django_session` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `django_session` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_addr`
--
...
CREATE TABLE ts_addr (
  ...
  shouji varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
...
ALTER SEQUENCE ts_addr_seq RESTART WITH 7;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX ts_ershouaddr_shui_id_6b375960_fk_ts_goumai_id ON ts_addr (shui_id);

--
-- SQLINES DEMO *** table `ts_addr`
--

LOCK TABLES ts_addr WRITE;
/* SQLINES DEMO *** LE `ts_addr` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_addr` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_chushou`
--
...
CREATE TABLE ts_chushou (
  ...
  jianjie varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (id),
  CONSTRAINT username UNIQUE  (username)
)  ;

ALTER SEQUENCE ts_chushou_seq RESTART WITH 10;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_chushou`
--

LOCK TABLES ts_chushou WRITE;
/* SQLINES DEMO *** LE `ts_chushou` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_chushou` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_dingdan`
--
...
CREATE TABLE ts_dingdan (
  ...
  maijia varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  title varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  img_url varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  price double precision NOT NULL,
  zfzt varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
...
ALTER SEQUENCE ts_dingdan_seq RESTART WITH 38;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX ts_dingdan_shui_id_d6904bc8_fk_ts_goumai_id ON ts_dingdan (shui_id);

--
-- SQLINES DEMO *** table `ts_dingdan`
--

LOCK TABLES ts_dingdan WRITE;
/* SQLINES DEMO *** LE `ts_dingdan` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_dingdan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_diqu`
--
...
CREATE TABLE ts_diqu (
  id int NOT NULL GENERATED ALWAYS AS IDENTITY,
  mingcheng varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  PRIMARY KEY (id)
)  ;

ALTER SEQUENCE ts_diqu_seq RESTART WITH 13;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_diqu`
--

LOCK TABLES ts_diqu WRITE;
/* SQLINES DEMO *** LE `ts_diqu` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_diqu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_fenlei`
--
...
ALTER SEQUENCE ts_fenlei_seq RESTART WITH 6;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_fenlei`
--

LOCK TABLES ts_fenlei WRITE;
/* SQLINES DEMO *** LE `ts_fenlei` DISABLE KEYS */;
INSERT INTO ts_fenlei VALUES (1,'Sightseeing'),(2,'Historical Sites'),(3,'Local Culture'),(4,'Literature & Art'),(5,'Scientific Exploration');
/* SQLINES DEMO *** LE `ts_fenlei` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_goumai`
--
...
ALTER SEQUENCE ts_goumai_seq RESTART WITH 40;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_goumai`
--

LOCK TABLES ts_goumai WRITE;
/* SQLINES DEMO *** LE `ts_goumai` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_goumai` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_guanli`
--
...
ALTER SEQUENCE ts_guanli_seq RESTART WITH 10;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_guanli`
--

LOCK TABLES ts_guanli WRITE;
/* SQLINES DEMO *** LE `ts_guanli` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_guanli` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_jingqu`
--
...
CREATE TABLE ts_jingqu (
  ...
  name varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  price int NOT NULL,
  dizhi varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  dengji varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  img_url varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  jianjie text CHARACTER SET utf8mb4 NOT NULL,
  zhuangtai varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  is_kaifang varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  is_shenhe varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  diqu_id int NOT NULL,
  fenlei_id int NOT NULL,
  maijia_id int NOT NULL,
  collect_num varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (id)
,
...
ALTER SEQUENCE ts_jingqu_seq RESTART WITH 29;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX ts_jingqu_diqu_id_12ef2b96_fk_ts_diqu_id ON ts_jingqu (diqu_id);
CREATE INDEX ts_jingqu_fenlei_id_e403b0fd_fk_ts_fenlei_id ON ts_jingqu (fenlei_id);
CREATE INDEX ts_jingqu_maijia_id_d5ae039e_fk_ts_chushou_id ON ts_jingqu (maijia_id);

--
-- SQLINES DEMO *** table `ts_jingqu`
--

LOCK TABLES ts_jingqu WRITE;
/* SQLINES DEMO *** LE `ts_jingqu` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_jingqu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_lb`
--
...
ALTER SEQUENCE ts_lb_seq RESTART WITH 11;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_lb`
--

LOCK TABLES ts_lb WRITE;
/* SQLINES DEMO *** LE `ts_lb` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_lb` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_message`
--
...
ALTER SEQUENCE ts_message_seq RESTART WITH 11;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

--
-- SQLINES DEMO *** table `ts_message`
--

LOCK TABLES ts_message WRITE;
/* SQLINES DEMO *** LE `ts_message` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_notify`
--
...
ALTER SEQUENCE ts_notify_seq RESTART WITH 6;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX ts_notify_user_id_79e3f230_fk_ts_goumai_id ON ts_notify (user_id);

--
-- SQLINES DEMO *** table `ts_notify`
--

LOCK TABLES ts_notify WRITE;
/* SQLINES DEMO *** LE `ts_notify` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_notify` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_pl`
--
...
CREATE TABLE ts_pl (
  ...
  content text,
  is_shenhe varchar(255) DEFAULT '待审核',
...
ALTER SEQUENCE ts_pl_seq RESTART WITH 31;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX jingqu_id ON ts_pl (jingqu_id);
CREATE INDEX shui_id ON ts_pl (shui_id);

--
-- SQLINES DEMO *** table `ts_pl`
--

LOCK TABLES ts_pl WRITE;
/* SQLINES DEMO *** LE `ts_pl` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- SQLINES DEMO *** or table `ts_sc`
--
...
ALTER SEQUENCE ts_sc_seq RESTART WITH 85;
/* SQLINES DEMO *** cter_set_client = @saved_cs_client */;

CREATE INDEX ts_shousc_shui_id_fc4d29ea_fk_ts_goumai_id ON ts_sc (shui_id);
CREATE INDEX ts_shousc_jingqu_id_4451932c_fk_ts_jingqu_id ON ts_sc (jingqu_id);

--
-- SQLINES DEMO *** table `ts_sc`
--

LOCK TABLES ts_sc WRITE;
/* SQLINES DEMO *** LE `ts_sc` DISABLE KEYS */;
...
/* SQLINES DEMO *** LE `ts_sc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- SQLINES DEMO ***  2025-06-07 20:07:41
