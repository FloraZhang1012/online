...
class Dingdan(models.Model):
    shui = models.ForeignKey(Goumai, on_delete=models.CASCADE)  # 买家
    gmsj = models.DateField(null=True, blank=True)              # 购买时间
    maijia = models.ForeignKey(Chushou, on_delete=models.CASCADE)  # ✅ 卖家改为外键
    title = models.CharField(max_length=255, null=True, blank=True)  # 商品标题
    img_url = models.CharField(max_length=255, null=True, blank=True)  # 商品图
    price = models.FloatField()
    zfzt = models.CharField(max_length=255, null=True, blank=True, default='待支付')  # 支付状态
    phone = models.CharField(max_length=255, null=True, blank=True, default='')     # 买家手机号
    addr = models.CharField(max_length=255, null=True, blank=True, default='')      # 买家地址
