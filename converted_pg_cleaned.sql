...
CREATE TABLE "auth_permission" (
  ...
  PRIMARY KEY ("id") ,
  UNIQUE KEY "auth_permission_codename_content_type_id_uniq" ("codename","content_type_id") 
)  COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE "ts_addr" (
  ...
  PRIMARY KEY ("id") ,
  KEY "ts_ershouaddr_shui_id_6b375960_fk_ts_goumai_id" ("shui_id") ,
...
CREATE TABLE "ts_dingdan" (
  ...
  "maijia" varchar(255)   DEFAULT NULL,
  "title" varchar(255)   DEFAULT NULL,
  "img_url" varchar(255)   DEFAULT NULL,
  "price" DOUBLE PRECISION NOT NULL,
  "zfzt" varchar(255)   DEFAULT NULL,
  "phone" varchar(255)   DEFAULT NULL,
  "addr" varchar(255)   DEFAULT NULL,
  "shui_id" bigint NOT NULL,
  "maijia_id" int DEFAULT NULL,
  PRIMARY KEY ("id") ,
  KEY "ts_dingdan_shui_id_d6904bc8_fk_ts_goumai_id" ("shui_id") ,
...
CREATE TABLE "ts_jingqu" (
  ...
  "img_url" varchar(255)   DEFAULT NULL,
  "jianjie" longtext   NOT NULL,
  "zhuangtai" varchar(255)   DEFAULT NULL,
  "is_kaifang" varchar(255)   DEFAULT NULL,
  "is_shenhe" varchar(255)   DEFAULT NULL,
  "diqu_id" int NOT NULL,
  "fenlei_id" int NOT NULL,
  "maijia_id" int NOT NULL,
  "collect_num" varchar(255)   DEFAULT NULL,
  PRIMARY KEY ("id") ,
  KEY "ts_jingqu_diqu_id_12ef2b96_fk_ts_diqu_id" ("diqu_id") ,
  KEY "ts_jingqu_fenlei_id_e403b0fd_fk_ts_fenlei_id" ("fenlei_id") ,
  KEY "ts_jingqu_maijia_id_d5ae039e_fk_ts_chushou_id" ("maijia_id") ,
...
CREATE TABLE "ts_sc" (
  ...
  "shui_id" bigint NOT NULL,
  PRIMARY KEY ("id") ,
  KEY "ts_shousc_shui_id_fc4d29ea_fk_ts_goumai_id" ("shui_id") ,
  KEY "ts_shousc_jingqu_id_4451932c_fk_ts_jingqu_id" ("jingqu_id") ,
...
-- Dump completed on 2025-06-07 21:04:49
